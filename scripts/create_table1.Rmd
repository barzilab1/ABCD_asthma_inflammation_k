...
"../outputs/table1_asthma_072722.csv")
```
...
"../outputs/table1_main_values_072722.csv")
...
#   )
# ),
# "../outputs/table1_main_072722.csv")

# Next part in Excel: save table1_main_072722.xlsx, move p-values to the 2nd sheet of table1_main_072722.xlsx, clean

# Get FDR adjusted p-values  
# p_values <- readxl::read_excel("../outputs/table1_main_072722.xlsx", sheet = 2) %>% 
#   mutate(adj_p = round(p.adjust(p, method = "fdr", ), 3))
# 
# writexl::write_xlsx(p_values, "../outputs/table1_main_adjp_072722.xlsx")
...
"../outputs/table1_main_total_072722.csv")

# Missing values
write.csv(print(questionr::freq.na(data = data_wide, table1_vars)), "../outputs/table1_main_missing_072722.csv")
