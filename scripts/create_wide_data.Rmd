...
# data_wide$asthma_num_attack_sum <- rowSums(data_wide[,which(grepl("medhx_ss_6l_times_p_l", colnames(data_wide)))], na.rm = T)

data_wide$Asthma_medications_2w_total_mean <- rowMeans(data_wide[,which(grepl("Asthma_medications_2w_total", colnames(data_wide)))], na.rm = T)
# data_wide$Asthma_medications_2w_total_sum <- rowSums(data_wide[,which(grepl("Asthma_medications_2w_total", colnames(data_wide)))], na.rm = T)
