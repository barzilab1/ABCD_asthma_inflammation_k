...
physicalhealth_sum <- read_csv("../outputs/physicalhealth_sum.csv") %>% dplyr::select(-contains("interview"), -sex)
...
# Suicide
suicide_long <- read_csv("../outputs/suicide_long.csv") %>% dplyr::select(-sex, -interview_age, -interview_date)
...
asthma_inflammation_wide <- asthma_inflammation_set %>%
  dplyr::select(age, contains(c("src", "event", "asthma_diagnosis", "asthma_attack_l", "asthma_composite", "recent_active_asthma", 
